...
define('CLICKPAY_SDK_VERSION', '2.11.3');
...
class ClickpayApi
{
    ...
    const PAYMENT_TYPES = [
        ...
        '2'  => ['name' => 'applepay', 'title' => 'Clickpay - ApplePay', 'currencies' => ['AED', 'SAR', 'ILS'], 'groups' => [ClickpayApi::GROUP_TOKENIZE, ClickpayApi::GROUP_AUTH_CAPTURE]],
